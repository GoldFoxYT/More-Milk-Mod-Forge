...
public class CartonMilkItem4 extends Item implements ICapabilityProvider {
    private static final int DRINK_DURATION = 32;

    public CartonMilkItem4(Properties pProperties) {
        super(pProperties);
    }
    ...
    public ItemStack finishUsingItem(ItemStack pStack, Level pLevel, LivingEntity pEntityLiving) {
        ...
        if (pEntityLiving instanceof Player $$4) {
            return ItemUtils.createFilledResult(pStack, $$4, new ItemStack(ModItems.MILK_CARTON5.get()), false);
        } else {
